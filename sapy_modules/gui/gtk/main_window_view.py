...
from sapy_modules.gui.gtk.pages import Graph_Page, New_Lom_Page, Lom_Page
...
class Main_Window_Controller(object):
    def __init__(self, view):
        ...
        self,view.notebook.append_page(Graph_Page(self.view),Gtk.Label("Graph"))
        #self.view.notebook.append_page(New_Lom_Page(self.view),Gtk.Label("+"))
